...
<head>
  ...
  <link rel="stylesheet" href="<?php echo baseurl ?>plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    <!-- iCheck -->
    ...
    <link rel="stylesheet" href="<?php echo baseurl ?>dist/css/custom.css">
    ...
    <link rel="stylesheet" href="<?php echo baseurl ?>plugins/summernote/summernote-bs4.min.css">
     <!-- SweetAlert2 -->
  <link rel="stylesheet" href="<?php echo baseurl ?>plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="<?php echo baseurl ?>plugins/jquery-ui/jquery-ui.min.js"></script>
    <!-- SweetAlert2 -->
    <script src="<?php echo baseurl ?>plugins/sweetalert2/sweetalert2.min.js"></script>
    <!-- Toastr -->
    <script src="<?php echo baseurl ?>plugins/toastr/toastr.min.js"></script>
    <script>
        var _baseurl_ = '<?php echo baseurl ?>';
    </script>
    <script src="<?php echo baseurl ?>dist/js/script.js"></script>
    ...
    #main-header:before{
        ...
        width:100%;
        height:100%;
        background-image:url(<?php echo baseurl.$_settings->info('cover') ?>);
