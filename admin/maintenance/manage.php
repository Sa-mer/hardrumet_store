		...
		<form action="" id="package-form">
            ...
            ?>
                <div class="d-flex w-100 align-items-center img-item">
                    <span><img src="<?php echo baseurl.$upload_path.'/'.$img ?>" width="150px" height="100px" style="object-fit:cover;" class="img-thumbnail" alt=""></span>
...
<script>
    ...
    function delete_img($path){
        ...
        $.ajax({
            url: _baseurl_+'classes/Master.php?f=delete_p_img',
            data:{path:$path},
            method:'POST',
            dataType:"json",
            error:err=>{
	...
	$(document).ready(function(){
		...
		$('#package-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_baseurl_+"classes/Master.php?f=save_package",
