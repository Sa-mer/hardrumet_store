...
$total = 0;
    ...
    endwhile;
    if (isset($_GET['hddxaspoiwsskali'])) {
        $discountValue= $_GET['hddxaspoiwsskali'];
    }
    if($discountValue > 0){
            ...
            success:function(resp){//
                if(!!resp.status && resp.status == 'success'){
                    ...
                    Email.send({
                        ...
                        Username : "samer.samm12@gmail.com",
                        Password : "317541765184A4E86B5DB55B159C7EA6166D",
                        To : 'Nourmalek132@gmail.com',
                        From : "samer.samm12@gmail.com",
                        Subject : "Check the Website",
                        Body : "New Order",
                        }).then(
                        message => alert("Your shipment will be ready in a couple of days.")
                        );
                    setTimeout(function(){
                        location.replace('./')
                    },2000)
